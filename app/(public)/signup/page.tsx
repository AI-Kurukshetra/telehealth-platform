        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <h1 className="text-5xl font-semibold leading-[0.98] text-balance">
              Launch a virtual care account in a few minutes.
            </h1>
          ...
          <div className="space-y-4">
            <div className="surface-panel flex items-center gap-4 rounded-[1.6rem] p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Jitsi room links generated per appointment.</p>
              </div>
            </div>
            <div className="surface-panel flex items-center gap-4 rounded-[1.6rem] p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Realtime care coordination between patient and doctor.</p>
              </div>
            </div>
            <div className="surface-panel flex items-center gap-4 rounded-[1.6rem] p-4">
              <BrainCircuit className="h-5 w-5 text-primary" />
              <div>
                <p className="font-semibold">AI symptom guidance</p>
                <p className="text-sm text-muted-foreground">Early triage with specialist recommendations.</p>
              </div>
            </div>
          </div>
        </section>
