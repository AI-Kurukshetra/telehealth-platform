    ...
    <>
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        <MetricCard
          ...
          description="Consultations and follow-ups assigned for this doctor."
          href="/doctor/appointments"
        />
        <MetricCard
          title="Pending notes"
          value={String(pendingNotesCount)}
          description="Appointments still waiting for a saved clinical record."
          href="/doctor/appointments"
        />
        <MetricCard
          title="Unread messages"
          value={String(messageCount)}
          description="New patient messages waiting in your inbox."
